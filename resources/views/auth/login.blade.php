...
<head>
    ...
    <title>Sebiduk Ekonomi | Log in </title>
    <link rel="stylesheet"
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="/" class="h1"><b>Sebiduk</b>Ekonomi</a>
            </div>
            <div class="card-body">
                <div class="callout callout-info text-left">
                    <p class="mb-0"><i class="fas fa-info-circle text-info mr-2"></i> Silahkan Login Menggunakan
                        Google Account</p>
                </div>
